...
if(!$connection){
	...
	*/
	...
	//inserting into the type of category table
	$typecategorystmt = $connection->prepare("INSERT INTO type_of_category( name, image) VALUES (?,?)");
	...
	$typecategorystmt->bind_param("ss", $tcategory,$imagetypecat);
    ...
    // everything is good to go !. 
		...
		// prepare and bind
		$itemstmt = $connection->prepare("INSERT INTO item( name, type_id, price, description, tags, image_name) VALUES (?, ?, ?, ?, ?, ?)");
		...
		$itemstmt->bind_param("sddsss", $itemname,$idType,$price,$description,$itemtags,$imageName);
