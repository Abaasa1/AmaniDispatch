            ...
            <section id="content">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Add Type of Category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                ...
                                <form method="post" action="uploadcattype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of Type of Category" name="typecategoryName">
					...
					<!--<div class="form-group">
                      <label for="exampleInputMarket">Select the type of market</label>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="uploadcategory.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of Category" name="categoryName">
                    
					
					<div class="form-group">
                      <br><label for="exampleInputMarket">Select the Type of Category</label>
                    <select name="typecategoryId">
                    <?php
						for($i=0;$i<$typecategorysize;$i++){
							echo'<option value="'.$typecategoryId[$i].'">'.$typecategoryName[$i].'</option>';
							}
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Add type of item<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="uploadtype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of Item type" name="itemName">
                    </div>
					
					<div class="form-group">
                      <label for="exampleInputMarket">Select the category</label>
                    <select name="categoryId">
                    <?php
						for($i=0;$i<$categorysize;$i++){
							echo'<option value="'.$categoryId[$i].'">'.$categoryName[$i].'</option>';
							}
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                          ...
                          <div class="card">
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="uploaditem.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Name</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of Item" name="itemName">
                    </div>
					
                    <div class="form-group">
                      <label for="exampleInputEmail1">Description</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Description of Item" name="descriptionName">
                    </div>
                    
                    <div class="form-group">
                      <label for="exampleInputEmail1">Price</label>
                      <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Price of Item" name="priceName">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Tags</label>
                      <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Item Tags" name="itemTags">
                    </div>
					<div class="form-group">
                      <label for="exampleInputMarket">Select the type of item </label>
                    <select name="typeId">
                    <?php
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Remove type of category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="removecattype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    
					<div class="form-group">
                      <label for="exampleInputMarket">Select the type of category</label>
                    <select name="catTypeId">
						<?php
							for($i=0;$i<$typecategorysize;$i++){
								echo'<option value="'.$typecategoryId[$i].'">'.$typecategoryName[$i].'</option>';
								}
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Remove category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="removecategory.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                        ...
                        <!-- Recent Posts -->
                            <div class="card">
                                <div class="card-header">
                                    <h2>Remove type of item<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="removeitemtype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    ...
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                         ...
                         <!-- Recent Posts -->
                            <div class="card">
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="removeitem.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    
					<div class="form-group">
                      <label for="exampleInputMarket">Select the item</label>
                    	<select name="itemId">
                      	 
						<?php
				
						$sqld = 'SELECT id,name,description,price,image_name FROM item ';
						$resultd = $connection->query($sqld);
						$rowNo=$resultd->num_rows;
						if ($resultd->num_rows > 0) {
						// output data of each row
					
							while($rowd = $resultd->fetch_assoc()) {
								//echo $rowd["name"].'" data-price="'.$rowd["price"].'';
				...
				?>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Change Image for Type of Category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="changecatimage.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                        <label>Name</label>
                      <select name="currcat">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Change Type of Category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="changecattype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                    ...
                    ?>
                      ...
                      <div class="form-group">
                      <label for="exampleInputEmail1">New Type of Category</label>
                      <select name="newcattype">
                          <?php
                              for($i=0;$i<$typecategorysize;$i++){
                                echo'<option value="'.$typecategoryId[$i].'">'.$typecategoryName[$i].'</option>';
                                }  
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                             ...
                             <div class="card">
                                <div class="card-header">
                                    <h2>Change Category<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="changecat.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Type of Item</label>
                      <select name="curritemtype">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="add" class="btn btn-primary">Submit</button>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h2>Change Type of Item<small></small></h2>
                                    <!--<ul class="actions">
                                        <li class="dropdown">
                                            <a href="" data-toggle="dropdown">
                                                <i class="zmdi zmdi-more-vert"></i>
                                ...
                                <div class="card-body m-t-0">
                                <form method="post" action="changeitemtype.php" role="form" enctype="multipart/form-data" style="padding:20px 20px">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Item</label>
                        <select name="curritem">
                      <?php
                        $sqld = 'SELECT id,name,description,price,image_name FROM item ';
						$resultd = $connection->query($sqld);
						$rowNo=$resultd->num_rows;
                      ...
                      <div class="form-group">
                          <label for="exampleInputEmail1">New Type of Item</label>
